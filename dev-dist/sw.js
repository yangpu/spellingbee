...
define(['./workbox-fa6cb374'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/words\/.*\.json$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\.(png|svg|ico|webmanifest)$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/.*\.supabase\.co\/rest\/v1\/challenges.*/i, new workbox.StaleWhileRevalidate({
